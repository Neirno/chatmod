...
public class Calculator {
     ...
     * @throws Exception в случае если исходное выражение содержит недопустимые символы
     */
     ...
     * @throws Exception в случае, если выражение содержит недопустимые символы (любые, кроме цифр, «+», «-», «*», «/», «.», «<»)
     */
